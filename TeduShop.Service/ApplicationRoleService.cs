...
namespace TeduShop.Service
{
    public interface IApplicationRoleService
    {
        ...
        bool AddRolesToGroup(IEnumerable<ApplicationGroupRole> roleGroups, string groupId);
    ...
    public class ApplicationRoleService : IApplicationRoleService
    {
        ...
        public bool AddRolesToGroup(IEnumerable<ApplicationGroupRole> roleGroups, string groupId)
        {
